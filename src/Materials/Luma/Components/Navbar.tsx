...
const Navbar = () => {
  ...
  const menuData: Record<string, any> = {
    ...
    "Women": {
      ...
      children: {
        "Tops": {
          url: "/LumaHome/",
          items: ["Jackets_page", "Hoodies & Sweatshirts", "Tees", "Bras & Tanks"]
        },
        "Bottoms": {
          url: "/LumaHome/Jackets_page",
          items: ["Pants", "Shorts"]
        }
      }
    },
  ...
  return (
    <nav className="bg-white sticky top-0 z-50 border-b border-gray-200">
      ...
      {isCartOpen && (
        <>
          <div className="fixed inset-0 bg-black/5 backdrop-blur-[1px] z-40" onClick={() => setIsCartOpen(false)} />
